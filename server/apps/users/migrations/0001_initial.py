    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(default='users/avatar/default/default.png',
                 upload_to='users/avatar/', verbose_name='avatar')),
                ('account_type', models.CharField(choices=[('customer', 'Customer'), (
                    'employee', 'Employee')], default='customer', max_length=50, verbose_name='account type')),
